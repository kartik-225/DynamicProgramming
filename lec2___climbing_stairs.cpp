...
int distinctWaysToClimbN_Stairs(int n){
	if(n == 0 or n == 1) return 1;

	int jump1 = distinctWaysToClimbN_Stairs(n-1);
	int jump2 = distinctWaysToClimbN_Stairs(n-2);
...
int main(){
	...
	int n = 6;
	cout << distinctWaysToClimbN_Stairs(n);
